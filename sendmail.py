...
class MailSender:
    ...
    """
    def __init__(self, in_username, in_password,in_reply, in_server=("smtp.gmail.com", 587), use_SSL=False):
    ...
    def __str__(self):
        return "Type: Mail Sender \n" \
               ...
               "Connected: {} \n" \
               "Username: {}, Password: {}, Reply: {}".format(self.server_name, self.server_port, self.connected, self.username, self.password,self.reply)
    ...
    def send_all(self, close_connection=False):
